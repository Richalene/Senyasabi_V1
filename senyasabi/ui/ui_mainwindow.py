...
def get_resource_path(relative_path):
    """Return an absolute resource path from the project root."""
...
class Ui_SenyaSabi(object):
    def setupUi(self, SenyaSabi):
        ...
        bg_image = get_resource_path("senyasabi/resources/img/Frame 6.png")
        self.label.setPixmap(QPixmap(bg_image))
